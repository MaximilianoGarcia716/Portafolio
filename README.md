...
Finalmente el proyectó concluyó con el desarrollo de un programa de generación de trayectorias para soldaduras con implementación con el toolbox Robotics de Peter Corke.
